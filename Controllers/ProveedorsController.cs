...
namespace SIPA.Controllers
{
    public class ProveedorsController : Controller
    {
        ...
        public ProveedorsController(SIPAContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProveedorID,Nombre,Direccion,Telefono")] Proveedor proveedor)
        {
