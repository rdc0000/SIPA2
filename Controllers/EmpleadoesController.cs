...
namespace SIPA.Controllers
{
    public class EmpleadoesController : Controller
    {
        ...
        public EmpleadoesController(SIPAContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmpleadoID,Nombre,Apellido,Documento,Cargo,Telefono,Email")] Empleado empleado)
        {
